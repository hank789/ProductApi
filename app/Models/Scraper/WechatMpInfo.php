...
class WechatMpInfo extends Model {
    ...
    protected $fillable = ['_id','name','wx_hao','newrank_id','is_auto_publish','company','description','wz_url','last_qunfa_id','create_time','status','logo_url','qr_url','group_id','user_id','rank_article_release_count'];
